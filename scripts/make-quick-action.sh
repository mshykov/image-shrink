	...
	<array>
		<dict>
			...
			<dict>
				...
				<key>InputUUID</key>
				<string>2B0E6B2F-7B0E-4E0E-9E6F-1C6A3C9F1001</string>
				<key>Keywords</key>
				<array>
					<string>Shell</string>
				...
				<key>OutputUUID</key>
				<string>2B0E6B2F-7B0E-4E0E-9E6F-1C6A3C9F1002</string>
				<key>UUID</key>
				<string>2B0E6B2F-7B0E-4E0E-9E6F-1C6A3C9F1003</string>
...
# build.sh passes a placeholder instead: the actions ship inside the bundle and the app fills
